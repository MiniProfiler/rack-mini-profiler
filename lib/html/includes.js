...
var MiniProfiler = (function() {
  ...
  var renderTemplate = function(json) {
    ...
    json['startedDate'] = MiniProfiler.renderDate(json['started'])
    json['hide_client_timings'] = !json['client_timings']
    json['formatted_client_timings'] = MiniProfiler.getClientTimings(json['client_timings'])
    console.log(json)
    // console.log(Handlebars.templates["test.js"](json))
